...
# Aquí se registran todas las rutas de mi aplicación
urlpatterns = [
    # el primer parametro es la ruta, el segundo parametro es el controlador de la ruta (viene de views.py) 
    # y el name='' es para colocar un nombre a la ruta en caso que queramos cambiarla más adelante.
